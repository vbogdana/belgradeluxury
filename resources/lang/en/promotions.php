...
return [
    ...
    */
	...
	'exit' => [
		...
		'title' => 'EXIT Adventure: Summer of Love 2017',
		...
		'offer' => [
			'title' => '{0}Belgrade Luxury VIP EXIT offer |{1}includes |{2}Optional tours ',
			'services' => '{0}accommodation:4 nights in a luxury apartment in the center of Novi Sad (1-4 people)|{1}tickets:VIP ticket for Exit (all 4 days of the festival)|{2}tickets:access to the VIP Gold Main Stage|{3}tickets:access to the VIP Main Stage|{4}tickets:access to the VIP Gold Dance Arena|{5}tickets:access to the VIP Terrace|{6}sightseeing:tour of Novi Sad and Fruska Gora, accompanied with a guide',
			'optional' => '{0}sightseeing:day tour of Belgrade, Serbian capital, to visit Kalemegdan, Skadarlija ...|{1}nightlife:experience nightlife in Belgrade',
		],
