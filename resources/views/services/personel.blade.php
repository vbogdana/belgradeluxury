...
<title>Belgrade Luxury - @lang('titles.personel') </title>
...
<meta property="og:url" content="{{ route("personel") }}">
<meta property="og:title" content="Belgrade Luxury - {{ Lang::get('titles.personel') }}" />
