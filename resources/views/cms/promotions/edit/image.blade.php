            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="panel-info" style="margin-bottom: 20px">
                        Here you can change {{ $imgType }} photo of a {{ $promotion }} promotion.
                    </div>
                    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ route('cms.promotions.edit.image', [$promID, $imgType]) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a class="btn btn-default" style="margin-left: 15px" href="{{ route('cms.promotions') }}">
                                    Cancel
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div style="margin-top: 15px">
                                        {{ Form::open(['route' => ['cms.promotions.delete.image', $promID, $imgType], 'method' => 'delete', 'class' => 'form-horizontal' ]) }}
                                        {{ Form::submit('Remove current '.$imgType.' image', array('class' => 'btn btn-danger')) }}
