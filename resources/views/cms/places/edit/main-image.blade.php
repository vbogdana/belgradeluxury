            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="panel-info" style="margin-bottom: 20px">
                        Here you can change the main photo of a place.
                    </div>
                    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ route('cms.places.edit.main-image', ['placeID' => $placeID]) }}">
                        {{ csrf_field() }}
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div style="margin-top: 15px">
                                        {{ Form::open(['route' => ['cms.places.delete.main-image', $placeID], 'method' => 'delete', 'class' => 'form-horizontal' ]) }}
