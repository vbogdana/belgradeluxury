            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="panel-info" style="margin-bottom: 20px">
                        Here you can change the main photo of a host.
                    </div>
                    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ route('cms.host.edit.main-image', ['hostID' => $hostID]) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a class="btn btn-default" style="margin-left: 15px" href="{{ route('cms.host') }}">
                                    Cancel
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div style="margin-top: 15px">
                                        {{ Form::open(['route' => ['cms.host.delete.main-image', $hostID], 'method' => 'delete', 'class' => 'form-horizontal' ]) }}
