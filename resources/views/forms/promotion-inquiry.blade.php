...
<meta name="description" content="{{ $object['meta_'.$locale] }}" />
<!-- Facebook share meta tags -->
<meta property="og:title" content="{{ $object['title_'.$locale] }} - Online {{ Lang::get('titles.inquiry') }} - Belgrade Luxury" />
<meta property="og:description" content="{{ $object['meta_'.$locale] }}" />
    ...
    <a rel="alternate" hreflang="{{ $localeCode }}" 
       href="
        <?php 
            ...
            $url = substr($url, 0, $titleStart + 1).str_replace(' ', '-', $object['url_'.$localeCode]);
            echo $url;
        ?>
       ">
        {{ $properties['native'] }}
            ...
            <div>
                ...
                <div class="description">                                      
                    <div class="text-uppercase">
                        <a class=""
                           href="{{ route("promotion", [ 'url' => str_replace(" ", "-", $object['url_'.$locale]) ]) }}">
                               <h5>{{ $object['title_'.$locale] }}</h5>
                        </a>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label for="object" class="col-xs-4 col-sm-offset-0 col-sm-3 control-label">@lang('forms.promotion'):</label>

                            <div class="col-xs-8 col-sm-9" style="padding-right: 30px">
                                <select id="object" class="form-control text-capitalize" name="object">
                                    
                                    @foreach($objects as $o)  
                                    <option value="{{ $o->promID }}"
                                            <?php
                                        if (isset($object)) {
                                            if ($object->promID === $o->promID) {
                                                echo "selected";
                                            }
                                        } 
                                        ?>
